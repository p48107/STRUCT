...
public:
	...
	int eliminar()
	{
		...
		else
		{
			mayor = raiz->getValor();
			//act cabeza
			if (bicola->getUltimo()->getValor()->getPadre() == NULL)
			{
				raiz = NULL;
			...
			else
			{
				...
				if (bicola->getUltimo()->getValor()->getPadre()->getIzq() != NULL && bicola->getUltimo()->getValor()->getPadre()->getDer() != NULL)
					bicola->insertarPrincipio(bicola->getUltimo()->getValor()->getPadre());
				raiz->setValor(bicola->getUltimo()->getValor()->getValor());
				if (bicola->getUltimo()->getValor()->getPadre()->getIzq()->getValor() == bicola->getUltimo()->getValor()->getValor())
					bicola->getUltimo()->getValor()->getPadre()->setIzq(NULL);
				else
					bicola->getUltimo()->getValor()->getPadre()->setDer(NULL);
				bicola->eliminarUltimo();
